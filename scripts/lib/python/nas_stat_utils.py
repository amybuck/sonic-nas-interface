...
'rx_bytes':                           'dell-if/if/interfaces-state/interface/statistics/ether-octets',
...
'rx_align_errors':                    'dell-if/if/interfaces-state/interface/statistics/ether-crc-align-errors',
