...
def main(argv):
    ...
    for name in if_name_list:
        del_cmd_str = '/opt/dell/os10/bin/nas_delete_interface.py ' + name
        set_cmd_str = ' /opt/dell/os10/bin/os10-config-fanout' + name + ' true'
        os.system(del_cmd_str)
        os.system(set_cmd_str)

    create_cmd_str = '/opt/dell/os10/bin/base_nas_create_interface.py'
